...
class DesktopUI:
    ...
    def _create_fonts(self) -> None:
        ...
        self.fonts = {
            "brand": tkfont.Font(root=self.root, family=family, size=25, weight="bold"),
            "tagline": tkfont.Font(root=self.root, family=family, size=10),
            "status": tkfont.Font(root=self.root, family=family, size=14, weight="bold"),
            "eyebrow": tkfont.Font(root=self.root, family=family, size=9, weight="bold"),
            "meaning": tkfont.Font(root=self.root, family=family, size=16, weight="bold"),
            "body": tkfont.Font(root=self.root, family=family, size=12),
            "body_bold": tkfont.Font(root=self.root, family=family, size=12, weight="bold"),
            "small": tkfont.Font(root=self.root, family=family, size=10),
            "button": tkfont.Font(root=self.root, family=family, size=11, weight="bold"),
        }
    ...
    def _build_footer(self) -> None:
        ...
        self.hear_button = self._action_button(inner, "Hear explanation", self._placeholder_command)
    ...
    def _action_button(
        ...
        *,
        ...
        bg = COLORS["accent"] if primary else COLORS["surface_3"]
        fg = COLORS["page"] if primary else COLORS["text"]
        active_bg = COLORS["focus"] if primary else COLORS["accent_surface"]
        return tk.Button(
            parent,
            text=text,
            command=command,
            ...
            takefocus=True,
            highlightthickness=2,
            highlightbackground=COLORS["surface_2"],
            highlightcolor=COLORS["focus"],
        )
    ...
    def _on_root_resize(self, event) -> None:
        ...
        # the optional audio action moves underneath instead of squeezing text.
        if event.width < 760:
            self.interpret_button.grid_configure(row=0, column=0, columnspan=2, padx=0, pady=0)
            self.hear_button.grid_configure(row=1, column=0, columnspan=2, padx=0, pady=(8, 0))
        else:
